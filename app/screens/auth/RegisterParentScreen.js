...
const RegisterParentScreen = () => {
    ...
    const handleLogin = () => {
        console.log('Login attempt:', { nidn, password });
        ...
        if (nidn === '120016729' && password === 'password') {
            ...
            // Perbaikan navigasi - gunakan push alih-alih replace untuk debugging
            try {
                router.push('/screens/dashboard/ParentDashboardScreen');
                console.log('Navigation executed'); 
            } catch (error) {
                console.error('Navigation error:', error);
                Alert.alert('Error Navigasi', 'Gagal berpindah ke dashboard: ' + error.message);
            }
        } else {
